      ...
      swiperList: [
        {
          ...
          content: '<p>集群部署： 我们有Elasticsearch认证工程师，拥有丰富的经验，可以帮助您设计和部署Elasticsearch集群，确保其高可用性和性能稳定性。</p><p>索引设计： 我们可以根据您的业务需求设计和优化Elasticsearch索引，以实现高效的数据检索和分析。</p><p>集群调优： 我们可以对您现有的Elasticsearch集群进行性能优化，包括调整硬件资源、优化查询和索引设置，以提高其性能和可靠性。</p><p>问题咨询： 我们提供专业的咨询服务，帮助您解决Elasticsearch集群部署、索引设计和性能调优等方面的问题。</p>',
        },
        {
          img: require("@/assets/img/banner2.jpg"),
          path: "",
          title: '人工智能',
          content: '我们团队熟悉人工智能技术的应用场景，可以帮助您解决各种问题，将人工智能应用到各种不同的任务和领域中，为用户提供更智能、更个性化的服务和体验。',
        },
        {
          img: require("@/assets/img/banner1.png"),
          path: "",
          title: '架构设计',
          content: '<p>日常需求： 我们团队具备丰富的经验和技术实力，可以承接各种后端开发项目，包括网站开发、API开发、数据库设计等。</p><p>架构设计： 我们采用先进的微服务架构，结合容器化部署和自动化运维，设计可扩展、高可用的后端架构，以满足不同规模项目的需求</p>',
        },
        {
          img: require("@/assets/img/banner2.jpg"),
          path: "",
          title: '性能优化',
          content: '<p>性能优化： 我们团队注重应用性能的持续优化，通过代码优化、数据库调优和缓存机制等手段，提升应用的响应速度和稳定性。</p><p>工具和技术： 我们使用先进的性能监控工具和性能测试框架，对应用进行全面的性能分析和测试，及时发现和解决潜在的性能问题。</p>',
        }
      ],
      customerList: [
        {
          ...
          title:
            "Elasticsearch集群使用",
          content:
            "<p>我们对贵司提供的Elasticsearch服务印象深刻！你们的服务不仅性能出色，而且非常稳定。我们的应用程序在你们部署的Elasticsearch集群上运行得非常顺畅，没有出现任何延迟或故障。</p><p>贵司的Elasticsearch服务是我们团队的首选！你们的服务不仅快速响应，而且稳定可靠。我们在高峰期也从未遇到过性能问题，感谢你们提供的优质服务！</p>"
        },
        {
          ...
          content:
            "<p>感谢你们提供的卓越支持和服务！每当我们遇到问题或需要帮助时，贵司的团队总是及时响应并提供专业的解决方案。你们的技术支持团队非常热情和专业，我们感到非常满意！</p><p>你们的团队不仅提供了出色的Elasticsearch服务，而且在整个合作过程中都表现出了极高的责任感和敬业精神。感谢您的努力和专业！</p>"
        },
        {
        ...
        },
        {
          ...
          title:
            "休假系统",
          content:
            "我们非常感谢你们团队开发的休假管理系统！这个系统为我们的企业带来了巨大的便利和效率提升。以前繁琐的休假申请流程现在变得简单快捷，员工可以轻松提交休假申请并实时跟踪审批进度。管理人员也能够更加方便地审批和管理休假请求，大大减少了人力成本和时间成本。系统的稳定性和易用性都得到了我们的一致好评，我们对这个系统的应用效果非常满意，感谢您团队的辛勤努力和专业服务！"
        }
      ],
      serverList: [
        {
          ...
          title: "核心优势1",
          content: "<p>丰富的大型系统开发经验</p>实现高可用性和高可扩展性系统"
        },
        {
          logo: require("@/assets/img/computer.png"),
          title: "核心优势2",
          content: "<p>利用ES来构建强大的搜索引擎和数据分析平台</p>实现高效的数据检索和分析"
        },
        {
          logo: require("@/assets/img/qq.png"),
          title: "核心优势3",
          content: "<p>利用大数据技术来处理和分析海量数据</p>，数据存储、处理、分析和可视化"
        },
        {
